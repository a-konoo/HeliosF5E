...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.FA18C
{
    ...
    public class FA18CInterface : DCSInterface
    {
            ...
            : base(name, "FA-18C_hornet", "pack://application:,,,/Helios;component/Interfaces/DCS/FA18C/ExportFunctions.lua")
        {
            ...
            AddFunction(new Switch(this, "23", "258", new SwitchPosition[] { new SwitchPosition("1.0", "ENABLE", "3012"), new SwitchPosition("0.0", "NORM", "3012") }, "ASPJ", "Auxiliary Release Switch, ENABLE/NORM", "%0.1f"));
            #endregion
            #region  TODO list
            ...
            AddFunction(new Switch(this, "62", "439", new SwitchPosition[]{new SwitchPosition("1.0","ON", "3001"), new SwitchPosition("0.5","STBY", "3001"), new SwitchPosition("0.0","OFF", "3001") }, "TODO list","FLIR Switch", "%0.1f"));    // elements["pnt_439"]     = default_3_position_tumb(_("FLIR Switch, ON/STBY/OFF"),                        0, 3110, 439, false, anim_speed_default * 0.5, false, 0.5, {0,1})
            AddFunction(new Switch(this, "62", "441", new SwitchPosition[]{new SwitchPosition("1.0","ARM", "3002"), new SwitchPosition("0.5","SAFE", "3002"), new SwitchPosition("0.0","AFT", "3002") }, "TODO list","LTD/R Switch", "%0.1f"));    // elements["pnt_441"]     = default_3_position_tumb(_("LTD/R Switch, ARM/SAFE/AFT"),                      0, 3111, 441, false, anim_speed_default * 0.5, false, 0.5, {0,1})
            AddFunction(new Switch(this, "62", "442", new SwitchPosition[] { new SwitchPosition("1.0", "ON", "3004"), new SwitchPosition("0.0", "OFF", "3004") }, "TODO list", "LST/NFLR Switch", "%1f"));    // elements["pnt_442"]     = default_2_position_tumb(_("LST/NFLR Switch, ON/OFF"),                         0, 3112, 442)
