...
namespace GadrocsWorkshop.Helios.Gauges.F5E.TACANChannel
{
    ...
    [HeliosControl("Helios.F5E.TACANChannel", "TACAN Channel", "F-5E Gauges", typeof(GaugeRenderer))]
    public class TACANChannel : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/TACANChannel/tacan_channel_faceplate.xaml", new Rect(0d, 0d, 275d, 100d)));

            _hundredsDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(15.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _hundredsDrum.Clip = new RectangleGeometry(new Rect(15.5d, 11.5d, 50d, 75d));
            Components.Add(_hundredsDrum);

            _tensDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(79.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(79.5d, 11.5d, 50d, 75d));
            Components.Add(_tensDrum);

            _onesDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(145.5d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _onesDrum.Clip = new RectangleGeometry(new Rect(145.5d, 11.5d, 50d, 75d));
            Components.Add(_onesDrum);

            _xModeImage = new GaugeImage("{Helios}/Gauges/F-5E/TACANChannel/tacan_channel_x_mode.xaml", new Rect(0d, 0d, 275d, 100d));
            Components.Add(_xModeImage);

            _yModeImage = new GaugeImage("{Helios}/Gauges/F-5E/TACANChannel/tacan_channel_y_mode.xaml", new Rect(0d, 0d, 275d, 100d));
