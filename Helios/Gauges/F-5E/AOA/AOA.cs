...
namespace GadrocsWorkshop.Helios.Gauges.F5E
{
    ...
    public class AOA : BaseGauge
    {
            ...
            : base("Flight Instuments", new Size(220d, 220d))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/AOA/aoa_backplate.xaml",
                new Rect(10d, 10d, 200d, 200d)));

            _offFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/AOA/aoa_off_flag.xaml",
                center2, new Size(28d, 46d), new Point(10d, 68d), -44d);
            _offFlagNeedle.Rotation = -90;
            Components.Add(_offFlagNeedle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/AOA/aoa_faceplate.xaml",
                new Rect(10d, 10d, 200d, 200d)));
            ...
            _needle = new GaugeNeedle("{Helios}/Gauges/F-5E/AOA/needle_aoa.xaml",
                                      center,
                                      new Size(20d, 100d),
                                      new Point(10d, 80d),
                                      220d);
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/AOA/AOAGaugeCover.png", new Rect(0d, 0d, 220d, 220d)));
        }
