...
namespace GadrocsWorkshop.Helios.Controls
{
    ...
    [HeliosControl("Helios.Base.FlipThrottle", "FlipThrottle", "F-5E", typeof(FlipThrottleRenderer))]
    public class FlipThrottle : FlipAnimationBase
    {
            ...
            : base("FlipThrottle", new Size(432, 264), new FlipAnimationStepCollection())
        {
            ...
            AnimationFrameImageNamePattern = "{Helios}/Images/F-5E/ThrottleParts/Throttle/Rth_01_01.png";
