...
namespace GadrocsWorkshop.Helios.Gauges.F5E.GuardedSwitchClosable
{
    ...
    [HeliosControl("Helios.F5E.GuardedSwitchClosable", "Guard", "F-5E", typeof(GuardedSwitchClosableRenderer))]
    class GuardedSwitchClosable : HeliosVisual
    {
        ...
        private Rect _guardUpRegion = GuardedSwitchClosable.GuardUpRegion;
        private Rect _switchRegion = GuardedSwitchClosable.SwitchRegion;
        private Rect _guardDownRegion = GuardedSwitchClosable.GuardDownRegion;

        private Point _mouseDownLocation;
        private bool _mouseAction;

        public GuardedSwitchClosable()
            : base("Guard Empty", new System.Windows.Size(65, 249))
        {
            _positionOneGuardUpImage = "{Helios}/Gauges/F-5E/GuardedSwitchClosable/guard-up-empty.png";
            _positionTwoGuardDownImage = "{Helios}/Gauges/F-5E/GuardedSwitchClosable/guard-down-off.png";
        ...
        protected override void OnPropertyChanged(PropertyNotificationEventArgs args)
        {
            if (args.PropertyName.Equals("Width") || args.PropertyName.Equals("Height"))
            {
                ...
                _guardUpRegion = GuardedSwitchClosable.GuardUpRegion;
                _guardUpRegion.Scale(scaleX, scaleY);
                _switchRegion = GuardedSwitchClosable.SwitchRegion;
                _switchRegion.Scale(scaleX, scaleY);
                _guardDownRegion = GuardedSwitchClosable.GuardDownRegion;
        ...
        {
            if (!WeaponGuardLock.CanGuardClose())
            {
                return;
            }
