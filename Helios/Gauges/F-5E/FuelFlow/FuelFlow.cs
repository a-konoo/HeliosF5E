...
namespace GadrocsWorkshop.Helios.Gauges.F5E.FuelFlow
{
    ...
    public class FuelFlow : BaseGauge
    {
            ...
            : base("FuelFlow", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/FuelFlow/fuelflow_faceplate.xaml", new Rect(10d, 10d, 150d, 150d)));

            _needleFlowLeft = new GaugeNeedle("{Helios}/Gauges/F-5E/Common/needle_accl_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 15d);
            Components.Add(_needleFlowLeft);

            _needleFlowRight = new GaugeNeedle("{Helios}/Gauges/F-5E/Common/needle_accr_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 15d);
