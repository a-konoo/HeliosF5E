...
namespace GadrocsWorkshop.Helios.Gauges.F5E.CabinPressure
{
    ...
    public class CabinPressure : BaseGauge
    {
            ...
            : base("CabinPressure", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/CabinPressure/cabinpress_faceplate.xaml", new Rect(10d, 10d, 150d, 150d)));

            _needle = new GaugeNeedle("{Helios}/Gauges/F-5E/CabinPressure/needle_long.xaml", center, new Size(30d, 130d), new Point(15d, 85d), 60d);
