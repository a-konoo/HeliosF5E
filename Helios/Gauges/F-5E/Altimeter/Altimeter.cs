...
namespace GadrocsWorkshop.Helios.Gauges.F5E.ADI
{
    ...
    public class Altimeter : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/Altimeter/altimeter_backplate.xaml", new Rect(32d, 38d, 300d, 300d)));

            _pneuTapeCalibration = new CalibrationPointCollectionDouble(0d, 0d, 50d, 50d);
            _pneuTape = new GaugeNeedle("{Helios}/Gauges/F-5E/Altimeter/pneu_tape.xaml", new Point(85d, 120d), new Size(80d, 20d), new Point(0d, 0d));
            ...
            _tensDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Altimeter/alt_drum_tape.xaml", new Point(71d, 164d), "#", new Size(10d, 15d), new Size(30d, 45d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(71d, 144d, 150d, 81d));
            Components.Add(_tensDrum);

            _drum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(101d, 164d), "#%00", new Size(10d, 15d), new Size(30d, 45d));
            _drum.Clip = new RectangleGeometry(new Rect(101d, 144d, 150d, 81d));
            Components.Add(_drum);

            _airPressureDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(214d, 233d), "###%", new Size(10d, 15d), new Size(15d, 20d));
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/Altimeter/altimeter_faceplate.xaml", new Rect(32d, 38d, 300d, 300d)));

            _needleCalibration = new CalibrationPointCollectionDouble(0d, 0d, 1000d, 360d);
            _needle = new GaugeNeedle("{Helios}/Gauges/F-5E/Altimeter/altimeter_needle.xaml", new Point(182d, 188d), new Size(16d, 257d), new Point(8d, 138.5d));
            Components.Add(_needle);

            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/Altimeter/AltiGaugeCover.png", new Rect(20d, 20d, 364d * 0.9, 376d * 0.88)));
