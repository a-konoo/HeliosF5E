...
namespace GadrocsWorkshop.Helios.Gauges.F5E.Hydraulic
{
    ...
    public class LiquidOxygenQty : BaseGauge
    {
            ...
            : base("Hydraulic", new Size(170, 170))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/Hydraulic/hydraulic_faceplate.xaml", new Rect(10d, 10d, 150, 150)));
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/Common/OtherGaugeRing.png", new Rect(0d, 0d, 170d, 170d)));

            _oxygenGauge = new GaugeNeedle("{Helios}/Gauges/F-5E/Common/needle_general.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 135d);
