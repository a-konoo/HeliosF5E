...
namespace GadrocsWorkshop.Helios.Gauges.F5E.EngineTemp
{
    ...
    public class EngineTemp : BaseGauge
    {
            ...
            : base("Engine Temp", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/EngineTemp/eng_temp_faceplate.xaml", new Rect(5d, 5d, 160d, 160d)));
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/EngineTemp/TempGaugeRing.png", new Rect(0d, 0d, 170d, 170d)));
            _needle = new GaugeNeedle("{Helios}/Gauges/F-5E/Common/needle_general.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 95d);
