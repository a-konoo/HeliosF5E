...
namespace GadrocsWorkshop.Helios.Gauges.F5E.AnalogueClock
{
    ...
    public class AnalogueClock : BaseGauge
    {
            ...
            : base("AnalogueClock", new Size(160, 160))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/AnalogueClock/clock_faceplate.xaml", new Rect(0, 0, 160, 160)));



            _minNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/AnalogueClock/clock_long_needle.xaml",
                center, new Size(25d, 75d), new Point(12.5d, 71d), 50d);
            Components.Add(_minNeedle);

            _hourNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/AnalogueClock/clock_short_needle.xaml",
                center, new Size(23.5d, 55d), new Point(11.75d, 50d), 135d);
            Components.Add(_hourNeedle);

            _secondNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/AnalogueClock/clock_second_needle.xaml",
