...
namespace GadrocsWorkshop.Helios.Gauges.F5E.HSI
{
    ...
    public class HSI : BaseGauge
    {
            ...
            : base("HSI", new Size(350, 350))
        {
            ...
            _milesDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(46d, 38d), "##%", new Size(10d, 15d), new Size(13d, 18d));
            _milesDrum.Clip = new RectangleGeometry(new Rect(46d, 38d, 39d, 30d));
            Components.Add(_milesDrum);

            _courseDrum = new GaugeDrumCounter("{Helios}/Gauges/F-5E/Common/drum_tape.xaml", new Point(266d, 38d), "##%", new Size(10d, 15d), new Size(13d, 18d));
            _courseDrum.Clip = new RectangleGeometry(new Rect(266d, 38d, 39d, 18d));
            Components.Add(_courseDrum);

            _compassNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_compass.xaml", center, new Size(243d, 243d), new Point(121.5, 121.5));
            Components.Add(_compassNeedle);

            _courseFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_bearing_flag.xaml", center, new Size(350, 350), center);
            _courseFlagNeedle.IsHidden = true;
            Components.Add(_courseFlagNeedle);

            _invalidDistImage = new GaugeImage("{Helios}/Gauges/F-5E/HSI/hsi_invalid_dist.xaml", new Rect(44d, 36d, 50d, 16d));
            _invalidDistImage.IsHidden = true;
            Components.Add(_invalidDistImage);

            _dfModeImage = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_df_mode.xaml", center, new Size(350, 350), center);
            _dfModeImage.IsHidden = false;
            Components.Add(_dfModeImage);

            _toFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_to_flag.xaml", center, new Size(350, 350), center);
            _toFlagNeedle.IsHidden = true;
            Components.Add(_toFlagNeedle);

            _fromFlagNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_from_flag.xaml", center, new Size(350, 350), center);
            _fromFlagNeedle.IsHidden = true;
            Components.Add(_fromFlagNeedle);

            _deviationCard = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_deviation_card.xaml", center, new Size(183, 183), new Point(91.5, 91.5));
            Components.Add(_deviationCard);

            _deviationNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_deviation_needle.xaml", center, new Size(6, 140), new Point(3, 70));
            Components.Add(_deviationNeedle);

            _headingBug = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_heading_bug.xaml", center, new Size(22, 9), new Point(11, 120));
            Components.Add(_headingBug);

            _desiredCourseNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_course_needle.xaml", center, new Size(12, 210), new Point(6, 105));
            Components.Add(_desiredCourseNeedle);



            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/HSI/HSIGaugeCover.png", new Rect(0, 0, 350, 350)));

            _bearingNeedle = new GaugeNeedle("{Helios}/Gauges/F-5E/HSI/hsi_bearing_needle.xaml", center, new Size(20, 265), new Point(10, 132.5));
            Components.Add(_bearingNeedle);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/F-5E/HSI/hsi_off_flag.xaml", new Rect(266d, 116d, 77d, 131d));
