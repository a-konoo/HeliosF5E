...
namespace GadrocsWorkshop.Helios.Gauges.F5E.NozzleIndicator
{
    ...
    public class NozzleIndicator : BaseGauge
    {
            ...
            : base("Nozzle Indicator", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{Helios}/Gauges/F-5E/NozzleIndicator/nozzle_faceplate.xaml", new Rect(10d, 10d, 150d, 150d)));
            ...
            _needle = new GaugeNeedle("{Helios}/Gauges/F-5E/Common/needle_general.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 70d);
