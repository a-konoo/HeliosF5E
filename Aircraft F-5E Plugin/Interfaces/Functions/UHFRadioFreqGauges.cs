...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.F5E.Functions
{
    ...
    public class UHFRadioFreqGauges : DCSFunctionPair
    {
        ...
        public UHFRadioFreqGauges(BaseUDPInterface sourceInterface)
        ...
        public UHFRadioFreqGauges(BaseUDPInterface sourceInterface, System.Runtime.Serialization.StreamingContext context)
        ...
        public override void ProcessNetworkData(string id, string value)
        {
            switch (id)
            {
                case "2302": // 2302
                    ...
                    Double.TryParse(parts[0], out double picked);
