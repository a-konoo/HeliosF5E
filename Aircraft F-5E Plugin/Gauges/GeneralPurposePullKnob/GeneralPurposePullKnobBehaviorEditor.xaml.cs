...
namespace GadrocsWorkshop.Helios.Controls.F5E
{
    ...
    /// <summary>
    /// Interaction logic for GeneralPurposePullKnobBehaviorEditor.xaml
    /// </summary>
    [HeliosPropertyEditor("Helios.F5E.GeneralPurposePullKnob", "Behavior")]
    public partial class GeneralPurposePullKnobBehaviorEditor : HeliosPropertyEditor
    {
        public GeneralPurposePullKnobBehaviorEditor()
        {
            InitializeComponent();
        }
