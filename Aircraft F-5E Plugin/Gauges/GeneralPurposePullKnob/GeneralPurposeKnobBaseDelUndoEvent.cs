...
{
    public class GeneralPurposeKnobBaseDelUndoEvent : IUndoItem
    {
        private int _index;
        private GeneralPurposeKnobBase _rotary;
        private GeneralPurposeKnobBasePosition _position;

        public GeneralPurposeKnobBaseDelUndoEvent(GeneralPurposeKnobBase rotary,
            GeneralPurposeKnobBasePosition position, int index)
        {
            _index = index;
            _rotary = rotary;
            _position = position;
