...
namespace GadrocsWorkshop.Helios.Controls.F5E
{
    ...
    [HeliosControl("Helios.F5E.StatePushPanel", "StatePushPanel", "F-5E", typeof(StatePushPanelRenderer))]
    public class StatePushPanel : HeliosVisual
    {
        ...
        public StatePushPanel() : base("StatePushPanel", new Size(102.5, 101))
        {
            ...
            AnimationFrameImageNamePattern =
                "{F-5E}/Images/RWRPanel/HANDOFF_01.png";
        ...
        public StatePushPanel(string name, Point posn, Size size,
            string animationImagePath, List<Tuple<int, string>> stateList)
            : base(name, new Size(size.Width, size.Height))
        {
            Left = posn.X;
            Top = posn.Y;
            AnimationFrameImageNamePattern = animationImagePath ?? "{F-5E}/Images/RWRPanel/HANDOFF_01.png";
            var positionFileName = Path.GetFileName(AnimationFrameImageNamePattern);
            Positions = new StatePushPanelStepCollection();
            ...
            stateList.ForEach(x =>
            {
                Positions.Add(new StatePushPanelPosition(this,x.Item1, x.Item2));
            });
