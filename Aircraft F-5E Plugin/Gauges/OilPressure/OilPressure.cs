...
namespace GadrocsWorkshop.Helios.Gauges.F5E.OilPressure
{
    ...
    public class OilPressure : BaseGauge
    {
            ...
            : base("OilPressure", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/OilPressure/oilpress_faceplate.xaml", new Rect(10d, 10d, 150d, 150d)));

            _leftNeedle = new GaugeNeedle("{F-5E}/Gauges/Common/needle_accl_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 180d);
            Components.Add(_leftNeedle);

            _rightNeedle = new GaugeNeedle("{F-5E}/Gauges/Common/needle_accr_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 180d);
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/OilPressure/OilPressureRing.png", new Rect(0d, 0d, 170d, 170d)));
