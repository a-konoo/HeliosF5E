...
namespace GadrocsWorkshop.Helios.Gauges.F5E.EngineRPM
{
    ...
    public class EngineRPM : BaseGauge
    {
            ...
            : base("Engine RPM", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/EngineRPM/eng_rpm_faceplate.xaml", new Rect(5d, 5d, 160d, 160d)));
            ...
            _needle = new GaugeNeedle("{F-5E}/Gauges/Common/needle_general.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 2d);
            Components.Add(_needle);

            _smallNeedleCalibration = new CalibrationPointCollectionDouble(0d, 0d, 100d, 360d);
            _smallNeedle = new GaugeNeedle("{F-5E}/Gauges/Common/eng_small_needle.xaml", center2, new Size(15d, 40d), new Point(7.5d, 20d), 0d);
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/EngineRPM/EngineRPM.png", new Rect(0d, 0d, 170d, 170d)));
        }
