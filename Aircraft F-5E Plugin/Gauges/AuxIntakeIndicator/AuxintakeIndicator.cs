...
namespace GadrocsWorkshop.Helios.Gauges.F5E
{
    ...
    public class AuxintakeIndicator : BaseGauge
    {
            ...
            : base("Flight Instuments", new Size(271d, 380d))
        {
            ...
            _closedNeedle = new GaugeNeedle("{F-5E}/Gauges/AuxIntakeIndicator/closed_card.xaml", new Point(36d, 190d), new Size(128d, 160d), new Point(0, 0));
            ...
            _openNeedle = new GaugeNeedle("{F-5E}/Gauges/AuxIntakeIndicator/oepn_card.xaml", new Point(36d, 190d), new Size(128d, 160d), new Point(0, 0));
            _openNeedle.Clip = new RectangleGeometry(new Rect(36d, 190d, 128d, 86d));
            Components.Add(_openNeedle);
            Components.Add(new GaugeImage("{F-5E}/Gauges/AuxIntakeIndicator/RightIntakeGauge.png", new Rect(0d, 0d, 271d, 380d)));
