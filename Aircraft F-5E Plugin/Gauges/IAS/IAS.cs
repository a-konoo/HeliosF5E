...
namespace GadrocsWorkshop.Helios.Gauges.F5E.IAS
{
    ...
    public class IAS : BaseGauge
    {
            ...
            : base("IAS", new Size(175d, 175d))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/IAS/ias_faceplate.xaml", new Rect(7.5d, 7.5d, 162.5d, 162.5d)));

            _machPlate = new GaugeNeedle("{F-5E}/Gauges/IAS/ias_mach_plate.xaml", center, new Size(100d, 100d), new Point(50d, 50d), 0d);
            Components.Add(_machPlate);

            _needlePlate = new GaugeNeedle("{F-5E}/Gauges/IAS/ias_needle_plate.xaml", center, new Size(105d, 105d), new Point(52.5d, 52.5d), 0d);
            Components.Add(_needlePlate);

            _needle = new GaugeNeedle("{F-5E}/Gauges/IAS/ias_needle.xaml", center, new Size(20d, 76d), new Point(10d, 70d), 0d);
            Components.Add(_needle);

            _limitSpeedIndicator = new GaugeNeedle("{F-5E}/Gauges/IAS/ias_limit_needle.xaml", center, new Size(10d, 80d), new Point(5d, 80d), 0d);
            Components.Add(_limitSpeedIndicator);

            Components.Add(new GaugeImage("{F-5E}/Gauges/IAS/IASGaugeCover.png", new Rect(0d, 0d, 175d, 175d)));
