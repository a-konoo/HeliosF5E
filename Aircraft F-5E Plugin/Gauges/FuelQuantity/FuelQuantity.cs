...
namespace GadrocsWorkshop.Helios.Gauges.F5E.FuelQuantity
{
    ...
    public class FuelQuantity : BaseGauge
    {
            ...
            : base("FuelQuantity", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/FuelQuantity/fuelqty_faceplate.xaml", new Rect(10d, 10d, 150d, 150d)));

            _needleFlowLeft = new GaugeNeedle("{F-5E}/Gauges/Common/needle_accl_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 210d);
            Components.Add(_needleFlowLeft);

            _needleFlowRight = new GaugeNeedle("{F-5E}/Gauges/Common/needle_accr_limit.xaml", center, new Size(48d, 77d), new Point(24d, 63d), 210d);
