...
namespace GadrocsWorkshop.Helios.Gauges.F5E.Accelerometer
{
    ...
    public class Accelerometer : BaseGauge
    {
            ...
            : base("Accelerometer", new Size(160, 160))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/Accelerometer/acc_faceplate.xaml", new Rect(16.5, 20.5, 125, 125)));

            _needleGS = new GaugeNeedle("{F-5E}/Gauges/Accelerometer/acc_needle.xaml", center, new Size(20d, 76d), new Point(10d, 65.5d), 135d);
            Components.Add(_needleGS);

            _needleAccMin = new GaugeNeedle("{F-5E}/Gauges/Accelerometer/acc_needle.xaml", center, new Size(20d, 76d), new Point(10d, 65.5d), 135d);
            Components.Add(_needleAccMin);

            _needleAccMax = new GaugeNeedle("{{F-5E}}/Gauges/Accelerometer/acc_needle.xaml", center, new Size(20d, 76d), new Point(10d, 65.5d), 135d);
            ...
            Components.Add(new GaugeImage("{F5-E}/Gauges/Accelerometer/ACCLGaugeCover.png", new Rect(0d, 0d, 160d, 160d)));
        }
