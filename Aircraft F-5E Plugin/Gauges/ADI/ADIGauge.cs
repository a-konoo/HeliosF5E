...
namespace GadrocsWorkshop.Helios.Gauges.F5E
{
    ...
    [HeliosControl("Helios.F5E.ADI", "Attitude Indicator", "F-5E Gauges", typeof(GaugeRenderer))]
    public class ADIGauge : BaseGauge
    {
        ...
        public ADIGauge()
            : base("Attitude Indicator", new Size(350, 350))
        {
            ...
            _ball = new GaugeNeedle("{F-5E}/Gauges/ADI/adi_ball.xaml", center2, new Size(250d, 1350d), new Point(125d, 677d));
            _ball.Clip = new EllipseGeometry(center3, 130d, 130d);
            Components.Add(_ball);

            Components.Add(new GaugeImage("{F-5E}/Gauges/ADI/ADIGaugeCover.png", new Rect(0d, 0d, 350d, 350d)));

            Components.Add(new GaugeImage("{F-5E}/Gauges/ADI/ADIGaugeGrass.png", new Rect(0d, 0d, 350d, 350d)));

            Components.Add(new GaugeImage("{F-5E}/Gauges/ADI/adi_bank_indicates.xaml", new Rect(30d, 30d, 290d, 290d)));


            Components.Add(new GaugeImage("{F-5E}/Gauges/ADI/adi_wing.xaml", new Rect(57d, 112d, 240d, 135d)));

            _offFlagImage = new GaugeImage("{F-5E}/Gauges/ADI/adi_off_flag.xaml", new Rect(58d, 210d, 55d, 56d));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            _bankNeedle = new GaugeNeedle("{F-5E}/Gauges/ADI/adi_bank_pointer.xaml", center2, new Size(18d, 250d), new Point(9d, 125d));
