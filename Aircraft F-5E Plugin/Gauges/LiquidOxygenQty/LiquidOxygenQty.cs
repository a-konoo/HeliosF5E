...
namespace GadrocsWorkshop.Helios.Gauges.F5E
{
    ...
    public class LiquidOxygenQty : BaseGauge
    {
            ...
            : base("LiquidOxygenQty", new Size(170d, 170d))
        {
            ...
            Components.Add(new GaugeImage("{F-5E}/Gauges/LiquidOxygenQty/liquidoxyqty_faceplate.xaml",
                new Rect(10d, 10d, 150d, 150d)));

            _liquidOxyQtyNeedle = new GaugeNeedle("{F-5E}/Gauges/Common/needle_general.xaml",
            ...
            Components.Add(new GaugeImage("./GaugeRing.png", new Rect(0d, 0d, 170d, 170d)));
